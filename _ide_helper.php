 ...
 */
     ...
     */ 
        ...
        public static function request($method, $url, $opt = [])
        {
                        ...
                        return $instance->request($method, $url, $opt);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function httpRequest($method, $url, $opt = [])
        {
                        /** @var \App\Helpers\RequestHelper $instance */
                        return $instance->httpRequest($method, $url, $opt);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function guzzleRequest($method, $url, $opt = [])
        {
                        /** @var \App\Helpers\RequestHelper $instance */
                        return $instance->guzzleRequest($method, $url, $opt);
        }
